  ...
  return (
    <section className="relative flex flex-1 bg-[var(--color-card-bg)] text-[var(--color-text-primary)] rounded-3xl font-sans overflow-hidden group">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-end gap-2 p-6">
        ...
        {props.buttonText && (
          <button className="px-8 py-3 mt-5 min-h-16 bg-white text-black rounded-full font-semibold text-lg transition-transform hover:scale-105 active:scale-95 cursor-pointer duration-300 animate-[slideUp_0.6s_ease-out_0.3s_backwards]">
            {props.buttonText}
          </button>
        )}
      </div>
